...
<body class="h-screenx overflow-hiddenx flex items-center justify-center" style="background: #edf2f7;">
  <style>
    [x-cloak] {
      display: none;
    }
      ...
      <div class="flex items-center justify-between px-4 py-2">
        ...
        <div class="flex items-center justify-start w-1/4">
          <a href="{{ route('/') }}">
            ...
            <span class="text-2xl font-semibold"><span class="text-indigo-500">{{ config('app.name', 'Tox')}}</span>-Payments </span>
          </a>
        </div>
